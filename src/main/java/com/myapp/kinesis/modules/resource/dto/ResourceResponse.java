...
public record ResourceResponse(
     ...
     * into a ResourceResponse (for the API). This is a professional pattern.
     *
     * @param entity The ResourceEntity from the database.
     * @return A new ResourceResponse.
     */
    @SneakyThrows // Lombok annotation to auto-handle the "try/catch" for JSON parsing
    public static ResourceResponse fromEntity(ResourceEntity entity) {
